...
import logging
import binascii
logger = logging.getLogger('services._can_manager')
...
class CanManager:
    ...
    async def start(self, bitrate=125000, interface='can0'):
        ...
        try:
            ...
            filters = [
                ...
                {"can_id": 0x120, "can_mask": 0x7FF, "extended": False}
    ...
    async def read_can_messages(self):
        """
        Asynchronously reads CAN messages from the bus and dispatches them to registered id_subscriber_map.
        """
    ...
    async def dispatch_message(self, message):
        """
        Dispatches received CAN message to registered id_subscriber_map based on the message ID.
        """
